...
urlpatterns = [
    ...
    path("my_tutorials/delete_booking/<int:booking_id>/", views.delete_booking, name="delete_booking"),
    path("my_tutorials/edit_booking/<int:booking_id>/", views.edit_booking, name="edit_booking"),
]